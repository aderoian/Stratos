...
ENUM_PROP(HORIZONTAL_AXIS, axis, math::Axis::Type, math::Axis::Type::X, math::Axis::Type::Z)
ENUM_PROP(AXIS, axis, math::Axis::Type, math::Axis::Type::X, math::Axis::Type::Y, math::Axis::Type::Z)
BOOLEAN_PROP(DIRECTION_UP, up)
BOOLEAN_PROP(DIRECTION_DOWN, down)
BOOLEAN_PROP(DIRECTION_NORTH, north)
BOOLEAN_PROP(DIRECTION_EAST, east)
BOOLEAN_PROP(DIRECTION_SOUTH, south)
BOOLEAN_PROP(DIRECTION_WEST, west)
ENUM_PROP(FACING_ANY, facing, math::Direction::Type, math::Direction::Type::North, math::Direction::Type::East, math::Direction::Type::South, math::Direction::Type::West, math::Direction::Type::Up, math::Direction::Type::Down)
ENUM_PROP(FACING_HOPPER, facing, math::Direction::Type, math::Direction::Type::Down, math::Direction::Type::North, math::Direction::Type::South, math::Direction::Type::West, math::Direction::Type::East)
ENUM_PROP(FACING_HORIZONTAL, facing, math::Direction::Type, math::Direction::Type::North, math::Direction::Type::South, math::Direction::Type::West, math::Direction::Type::East)
INT_PROP(FLOWER_AMOUNT, flower_amount, 1, 4)
INT_PROP(SEGMENT_AMOUNT, segment_amount, 1, 4)
ENUM_PROP(ORIENTATION, orientation, Orientation, Orientation::Down_East, Orientation::Down_North, Orientation::Down_South, Orientation::Down_West, Orientation::Up_East, Orientation::Up_North, Orientation::Up_South, Orientation::Up_West, Orientation::West_Up, Orientation::East_Up, Orientation::North_Up, Orientation::South_Up)
ENUM_PROP(BLOCK_FACE, face, BlockFace, BlockFace::Floor, BlockFace::Wall, BlockFace::Ceiling)
ENUM_PROP(ATTACHMENT, attachment, Attachment, Attachment::Floor, Attachment::Ceiling, Attachment::Single_Wall, Attachment::Double_Wall)
...
ENUM_PROP(RAIL_SHAPE, shape, RailConnection, RailConnection::North_South, RailConnection::East_West, RailConnection::Ascending_East, RailConnection::Ascending_West, RailConnection::Ascending_North, RailConnection::Ascending_South, RailConnection::South_East, RailConnection::South_West, RailConnection::North_West, RailConnection::North_East)
ENUM_PROP(STRAIGHT_RAIL_SHAPE, shape, RailConnection, RailConnection::North_South, RailConnection::East_West, RailConnection::Ascending_East, RailConnection::Ascending_West, RailConnection::Ascending_North, RailConnection::Ascending_South)
...
ENUM_PROP(INSTRUMENT, instrument, NoteBlockInstrument, NoteBlockInstrument::Harp, NoteBlockInstrument::BaseDrum, NoteBlockInstrument::Snare, NoteBlockInstrument::Hat, NoteBlockInstrument::Bass, NoteBlockInstrument::Flute, NoteBlockInstrument::Bell, NoteBlockInstrument::Guitar, NoteBlockInstrument::Chime, NoteBlockInstrument::Xylophone, NoteBlockInstrument::Iron_Xylophone, NoteBlockInstrument::Cow_Bell, NoteBlockInstrument::Didgeridoo, NoteBlockInstrument::Bit, NoteBlockInstrument::Banjo, NoteBlockInstrument::Pling, NoteBlockInstrument::Zombie, NoteBlockInstrument::Skeleton, NoteBlockInstrument::Creeper, NoteBlockInstrument::Dragon, NoteBlockInstrument::Wither_Skeleton, NoteBlockInstrument::Piglin, NoteBlockInstrument::Custom_Head)
ENUM_PROP(PISTON_TYPE, type, PistonType, PistonType::Normal, PistonType::Sticky)
ENUM_PROP(SLAB_TYPE, type, SlabType, SlabType::Top, SlabType::Bottom, SlabType::Double)
ENUM_PROP(STAIR_SHAPE, shape, StairShape, StairShape::Straight, StairShape::Inner_Left, StairShape::Inner_Right, StairShape::Outer_Left, StairShape::Outer_Right)
...
ENUM_PROP(THICKNESS, thickness, Thickness, Thickness::Tip_Merge, Thickness::Tip, Thickness::Frustum, Thickness::Middle, Thickness::Base)
ENUM_PROP(SCULK_SENSOR_PHASE, sculk_sensor_phase, SculkSensorPhase, SculkSensorPhase::Inactive, SculkSensorPhase::Active, SculkSensorPhase::Cooldown)
...
ENUM_PROP(TRIAL_SPAWNER_STATE, trial_spawner_state, TrialSpawnerState, TrialSpawnerState::Inactive, TrialSpawnerState::Waiting_For_Players, TrialSpawnerState::Active, TrialSpawnerState::Waiting_For_Reward_Ejection, TrialSpawnerState::Ejecting_Reward, TrialSpawnerState::Cooldown)
...
ENUM_PROP(TEST_BLOCK_MODE, mode, TestBlockMode, TestBlockMode::Start, TestBlockMode::Log, TestBlockMode::Fail, TestBlockMode::Accept)
