...
public:
    ...
    static const BooleanProperty* DIRECTION_UP();
    static const BooleanProperty* DIRECTION_DOWN();
    static const BooleanProperty* DIRECTION_NORTH();
    static const BooleanProperty* DIRECTION_EAST();
    static const BooleanProperty* DIRECTION_SOUTH();
    static const BooleanProperty* DIRECTION_WEST();
    static const EnumProperty<math::Direction::Type>* FACING_ANY();
