...
REGISTER_BLOCK_BLOCKSTATES(POWERED_RAIL, "powered_rail", StateProperties::POWERED(), StateProperties::STRAIGHT_RAIL_SHAPE(), StateProperties::WATERLOGGED())
REGISTER_BLOCK_BLOCKSTATES(DETECTOR_RAIL, "detector_rail", StateProperties::POWERED(), StateProperties::STRAIGHT_RAIL_SHAPE(), StateProperties::WATERLOGGED())
...
REGISTER_BLOCK_BLOCKSTATES(ACTIVATOR_RAIL, "activator_rail", StateProperties::POWERED(), StateProperties::STRAIGHT_RAIL_SHAPE(), StateProperties::WATERLOGGED())
...
REGISTER_BLOCK_BLOCKSTATES(TORCHFLOWER_CROP, "torchflower_crop", StateProperties::AGE_1())
...
REGISTER_BLOCK_BLOCKSTATES(BEETROOTS, "beetroots", StateProperties::AGE_3())
REGISTER_BLOCK(DIRT_PATH, "dirt_path")
REGISTER_BLOCK(END_GATEWAY, "end_gateway")
REGISTER_BLOCK_BLOCKSTATES(REPEATING_COMMAND_BLOCK, "repeating_command_block", StateProperties::CONDITIONAL(), StateProperties::FACING_ANY())
REGISTER_BLOCK_BLOCKSTATES(CHAIN_COMMAND_BLOCK, "chain_command_block", StateProperties::CONDITIONAL(), StateProperties::FACING_ANY())
...
REGISTER_BLOCK_BLOCKSTATES(SHULKER_BOX, "shulker_box", StateProperties::FACING_ANY())
...
REGISTER_BLOCK_BLOCKSTATES(PALE_MOSS_CARPET, "pale_moss_carpet", StateProperties::BOTTOM(), StateProperties::EAST_WALL_SHAPE(), StateProperties::NORTH_WALL_SHAPE(), StateProperties::SOUTH_WALL_SHAPE(), StateProperties::WEST_WALL_SHAPE())
